...
public class RelatedPartitionDescResult {
    ...
    public void setDescs(Map<MTMVRelatedTableIf, Map<PartitionKeyDesc, Set<String>>> descs) {
        this.descs = descs;
    }
    ...
    public void setItems(Map<MTMVRelatedTableIf,Map<String, PartitionItem>> items) {
        this.items = items;
    }
    ...
    public void setRes(Map<PartitionKeyDesc, Map<MTMVRelatedTableIf, Set<String>>> res) {
        this.res = res;
    }
}
